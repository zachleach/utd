...
After proving the expression holds for some base cases $F_0$ and $F_1$, the next step is algebra. Setup the expression $F{n + 1}$ in terms of $F_n$, then solve (see below).
