...
Note that $f_1 = \Omega(f_2)$ basically means $f_1 \leq f_2$ (in terms of growth). Therefore, the order of functions $f_1 = \Omega(f_2), f_2 = \Omega(f_3), ..., f_{29} = \Omega(f_{30})$ is as follows:
