...
In other words, this problem asks you to verify whether these two inequalities hold: 1.) $\lceil \lg n \rceil ! \leq c \cdot n^k$, and 2.) $\lceil \lg \lg n \rceil ! \leq c \cdot n^k$.
