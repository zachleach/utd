...
Polynomially bounded means $f_n = \O(n^k)$ for some constant $k$. Therefore, to demonstrate whether $f_n$ is polynomially bounded, prove or disprove the inequality $f_n \leq c \cdot n^k$.
