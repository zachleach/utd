...
For the first function, without loss of generality, assume $n = 2^a$ (where $a \in \mathbb{N}$). This reduces the $\lg$ and removes the ceil.
\begin{align*}
...
For the second, without loss of generality, assume $n = 2^{2^a}$ (where $a \in \mathbb{N}$).
