...
For the first function, without loss of generality, let $n = 2^a$ (where $a \in \mathbb{N}$). This reduces the $\lg$ and removes the ceil.
\begin{align*}
...
For the second function, without loss of generality, let $n = 2^{2^a}$ (where $a \in \mathbb{N}$
