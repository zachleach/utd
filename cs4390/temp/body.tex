...
\ii{A 3-kHz (analog) signal is sampled every 1 msec. \bb{What is the (minimum) data rate of a digital channel required to carry this signal?} Assume that the quantization uses 256 levels.}
