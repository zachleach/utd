...
Where $R$ is the data rate, $B$ is the bandwidth, and $Q$ is the quantization levels. The minimum data rate is $2 \times (3 \cdot 10^3) \times \log_2(256)$ = \ul{48,000 bits per second.}
