...
Where $c$ represents the speed of light in a vacuum (e.g., $3 \cdot 10^5$ km/s). For \ul{GEO: 0.233 seconds} [$2 \cdot (35,800) / 3\cdot 10^{5}$], \ul{MEO: 0.12 seconds} [$2 \cdot (18,000) / 3\cdot 10^5$], and \ul{LEO: 0.015 seconds} [$2 \cdot (750) / 3 \cdot 10^5$].
