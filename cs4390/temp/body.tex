...
The best-, average-, and worst-case di-directional ring is 1, $n / 2$, and $n - 1$ hops, respectively (e.g., the source and destination nodes are adjacent, the average of 1 hop and $n - 1$ hops is $~ n/2$, and at worst the message must travel across all $n - 1$ nodes).
