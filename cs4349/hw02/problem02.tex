...
Since we have shown $F_{i}$ is obtainable via $F_{i - 1}$, we have completed the inductive step. Since both the inductive step and base cases have been shown, the proof by induction is complete.
